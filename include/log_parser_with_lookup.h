...
class LogParserWithLookup: public LogParser
{
    public:
        ...
        LogParserWithLookup(DatabaseConnectionPool database, std::string main_table, bool single_lookup_table = false);
        ...
        void insert_all_and_update_lookup(std::vector<std::string> log_lists);
