...
class LogParser: public BaseLogParser
{
    public:
        ...
        LogParser(DatabaseConnectionPool &database, const std::string main_table, const bool single_lookup_table = false, const bool lookup = true, const std::string file_type = "tsv");
