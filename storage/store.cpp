...
LogParserWithLookup::LogParserWithLookup(DatabaseConnectionPool &database, const std::string main_table, const bool single_lookup_table, const std::string file_type): LogParser(database, file_type)
{
...
void LogParserWithLookup::insert_all_log_files(std::vector<std::string> log_lists)
{
