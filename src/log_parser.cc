...
LogParser::LogParser(DatabaseConnectionPool &database, const std::string main_table, const std::string file_type): BaseLogParser(database, file_type)
{
...
long long LogParser::database_size()
{
